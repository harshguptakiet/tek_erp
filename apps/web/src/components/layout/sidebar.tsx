...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    permission: PERMISSIONS.LIVE_CLASSES_VIEW,
  },
  {
    name: 'Assignments',
    href: '/assignments',
  ...
  },
  {
    name: 'Messages',
    href: '/messages',
    icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>,
  },
  {
    name: 'Events',
    href: '/events',
  ...
  return (
    <div className="flex flex-col w-64 bg-gray-900 h-screen">
      ...
      <div className="flex items-center justify-center h-16 px-4 bg-gray-800">
        <h1 className="text-xl font-bold text-white">EduBharti</h1>
      </div>
      ...
      <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        {navigation.map((item) => {
          ...
          const NavLink = (
            ...
            >
              <span className={cn('mr-3', isActive ? 'text-white' : 'text-gray-400 group-hover:text-gray-300')}>
                {item.icon}
              </span>
              {item.name}
              {item.badge && (
