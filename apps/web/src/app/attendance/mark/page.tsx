                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-5 gap-2 mt-3">
                            <button
                              ...
                              className={`px-3 py-2 rounded text-sm font-medium transition-colors ${student.status === 'PRESENT'
                            ...
                            <button
                              ...
                              className={`px-3 py-2 rounded text-sm font-medium transition-colors ${student.status === 'ABSENT'
                            ...
                            <button
                              ...
                              className={`px-3 py-2 rounded text-sm font-medium transition-colors ${student.status === 'LATE'
                            ...
                            <button
                              ...
                              className={`px-3 py-2 rounded text-sm font-medium transition-colors ${student.status === 'HALF_DAY'
                            ...
                            <button
                              ...
                              className={`px-3 py-2 rounded text-sm font-medium transition-colors ${student.status === 'EXCUSED'
