    ...
    queryFn: async () => [
      {
        ...
        type: 'DIRECT',
        participants: [
          { id: 'u1', name: 'Dr. Rajesh Kumar', role: 'TEACHER', avatar: null },
        ],
        lastMessage: {
      ...
      },
      {
        ...
        type: 'DIRECT',
        participants: [
          { id: 'u2', name: 'Priya Singh', role: 'PARENT', avatar: null },
        ],
        lastMessage: {
          text: 'When is the next parent-teacher meeting?',
      ...
      },
      {
        ...
        participants: [
          { id: 't1', name: 'Dr. Rajesh Kumar', role: 'TEACHER' },
          { id: 't2', name: 'Ms. Anjali Sharma', role: 'TEACHER' },
          { id: 't3', name: 'Mr. Suresh Verma', role: 'TEACHER' },
        ],
        lastMessage: {
