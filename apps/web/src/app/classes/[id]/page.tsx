...
export default function ClassDetailPage({ params }: { params: { id: string } }) {
  ...
  const { data: classData, isLoading } = useQuery({
    ...
    queryFn: async () => ({
      ...
      femaleStudents: 20,
      subjects: [
        { id: 's1', name: 'Mathematics', teacher: 'Mr. Kumar', periods: 6 },
        { id: 's2', name: 'Science', teacher: 'Dr. Verma', periods: 6 },
        { id: 's3', name: 'English', teacher: 'Mrs. Singh', periods: 5 },
        { id: 's4', name: 'Social Studies', teacher: 'Mr. Reddy', periods: 5 },
        { id: 's5', name: 'Hindi', teacher: 'Mrs. Patel', periods: 4 },
        { id: 's6', name: 'Computer Science', teacher: 'Mr. Khan', periods: 3 },
      ],
      students: [
        {
          id: '1',
