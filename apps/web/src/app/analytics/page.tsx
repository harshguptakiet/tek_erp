    ...
    queryFn: async () => ({
      ...
      attendance: {
        ...
        byClass: [
          ...
          { class: 'Class 10', percentage: 89.8, students: 210, present: 189 },
          { class: 'Class 9', percentage: 87.3, students: 225, present: 196 },
          { class: 'Class 8', percentage: 88.1, students: 240, present: 211 },
        ],
        topPerformers: [
          { name: 'Aarav Kumar', class: 'Class 10', percentage: 98.5 },
          { name: 'Diya Sharma', class: 'Class 11', percentage: 97.8 },
          { name: 'Rohan Patel', class: 'Class 12', percentage: 96.3 },
        ],
      },
      academic: {
        averageGrade: 78.3,
        trend: '+1.5%',
        subjectPerformance: [
          { subject: 'Mathematics', average: 82.5, students: 1250, trend: 'up' },
          { subject: 'Science', average: 79.8, students: 1250, trend: 'up' },
          { subject: 'English', average: 75.2, students: 1250, trend: 'down' },
          { subject: 'Social Studies', average: 77.9, students: 1250, trend: 'up' },
          { subject: 'Hindi', average: 73.5, students: 1250, trend: 'stable' },
        ],
        gradeDistribution: [
          ...
          { grade: 'C+', count: 125, percentage: 10 },
          { grade: 'C', count: 63, percentage: 5 },
        ],
      },
      engagement: {
        assignmentSubmissionRate: 87.5,
        averageSubmissionTime: '2.3 days',
        liveClassAttendance: 82.3,
        contentAccessRate: 76.8,
        mostActiveStudents: [
          { name: 'Aarav Kumar', activities: 145, class: 'Class 10' },
          { name: 'Priya Singh', activities: 138, class: 'Class 11' },
          { name: 'Arjun Verma', activities: 132, class: 'Class 12' },
        ],
      },
      finance: {
        totalCollected: 85600000,
        totalPending: 12400000,
        collectionRate: 87.3,
        trend: '+3.2%',
        byClass: [
          { class: 'Class 12', collected: 15200000, pending: 1800000, rate: 89.4 },
          { class: 'Class 11', collected: 17500000, pending: 2500000, rate: 87.5 },
          { class: 'Class 10', collected: 18900000, pending: 2100000, rate: 90.0 },
        ],
      },
    }),
  });
                  ...
                  {analyticsData?.finance.byClass.map((classData: any) => (
                    <div key={classData.class}>
                      ...
                      <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div
                          className={`h-full ${
                            classData.rate >= 90 ? 'bg-green-600' :
